...
var Pet = function Pet(props) {
  ...
  // with JSX
  return _react.default.createElement("div", null, _react.default.createElement("h1", null, props.name), _react.default.createElement("h2", null, props.animal), _react.default.createElement("h2", null, props.breed)); // parenthesis allows us to continue the code in the following line(s)
};
...
function (_React$Component) {
  ...
  return App;
}(_react.default.Component); // React.createElement(App) is equivalent to React.createElement(App, {}, null)
